...
msbuild.exe %srcFolder%\source\af.modul.befragen\af.modul.befragen.sln
msbuild.exe %srcFolder%\source\af.ui\af.ui.sln
msbuild.exe %srcFolder%\source\af.application\af.application.2010.sln
rem msbuild.exe %srcFolder%\source\af.application\af.application.sln
